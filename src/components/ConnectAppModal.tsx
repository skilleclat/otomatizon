            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-2 p-1 bg-[#FAF9F5] border border-[#EAE7DF] rounded-2xl">
                ...
                >
                  ...
                  <span>Option B : Code à 8 Chiffres</span>
                </button>
                ...
                >
                  ...
                  <span>Option A : Scan QR Code</span>
                </button>
              </div>
              ...
              {whatsappMode === "phone" ? (
                <div className="space-y-4 animate-fadeIn">
                  ...
                  <div className="space-y-1.5 font-mono">
                    <label className="text-xs font-bold text-[#121316] flex items-center justify-between">
                      ...
                      <span className="text-[10px] text-emerald-700 font-normal">Avec indicatif pays</span>
                    </label>
                  ...
                  <div className="p-4 rounded-2xl bg-[#ECFDF5]/60 border border-[#A7F3D0] space-y-3">
                    <div className="flex items-center justify-between">
                      <span className="text-[10px] font-mono uppercase tracking-widest text-[#15803D] font-bold flex items-center gap-1.5">
                        <span className="w-2 h-2 rounded-full bg-[#15803D] animate-pulse" />
                        Code d&rsquo;Association WhatsApp Actif
                      </span>
                      <span className="text-[10px] font-mono text-[#75777E]">Valide 3 minutes</span>
                    </div>

                    <div className="flex items-center justify-between p-3 bg-white border border-[#A7F3D0] rounded-xl">
                      <div className="font-mono text-xl sm:text-2xl font-extrabold tracking-widest text-[#002E25]">
                      ...
                      >
                        {codeCopied ? (
                          <>
                            ...
                            <span className="text-[#15803D]">Copié !</span>
                          </>
                        ) : (
                          <>
                            <Copy className="w-3 h-3 text-[#75777E]" />
                            <span>Copier</span>
                          </>
                        )}
                      </button>
                    ...
                    <div className="p-3 bg-white/80 border border-[#A7F3D0]/60 rounded-xl text-[11px] text-[#4A4B50] space-y-1 font-mono">
                      <p className="font-bold text-[#121316]">Comment saisir le code sur votre téléphone :</p>
                      <ol className="list-decimal pl-4 space-y-0.5 text-[10px] leading-relaxed text-[#4A4B50]">
                        <li>Ouvrez <strong>WhatsApp</strong> &gt; <strong>Appareils connectés</strong> <em>(Linked devices)</em>.</li>
                        <li>Appuyez sur <strong>Connecter un appareil</strong> &gt; <strong>Associer avec un numéro de téléphone</strong> <em>(Link with phone number)</em>.</li>
                        <li>Entrez le code <strong className="text-[#002E25]">{activePairingCode || "OTOM-2026"}</strong> ci-dessus sur votre combiné.</li>
                      </ol>
                    </div>
                  </div>
                ...
                <div className="space-y-4 animate-fadeIn">
                  <div className="p-5 rounded-2xl bg-[#FAF9F5] border border-[#EAE7DF] flex flex-col items-center text-center space-y-3">
                    <div className="p-3 bg-white rounded-2xl border border-[#EAE7DF] shadow-sm relative">
                      {realQrDataUrl ? (
                        <img 
                          src={realQrDataUrl} 
                        ...
                        <div className="w-48 h-48 flex items-center justify-center bg-[#FAF9F5] rounded-lg">
                          <RefreshCw className="w-6 h-6 animate-spin text-[#15803D]" />
                        </div>
                      )}
                    </div>

                    <p className="text-[11px] font-mono text-[#75777E]">
                      Scannez ce QR Code depuis WhatsApp &gt; <strong>Appareils connectés</strong> &gt; <strong>Connecter un appareil</strong>.
                    </p>
                  </div>
                </div>
              )}
              ...
              <div className="space-y-2">
                <span className="text-[10px] font-mono uppercase tracking-widest text-[#75777E] font-bold block">
                  Permissions gérées par Otomatizon
                </span>

                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  <div className="flex items-start gap-2.5 p-2.5 rounded-xl bg-[#FAF9F5] border border-[#EAE7DF]">
                    <MessageSquare className="w-4 h-4 text-emerald-700 shrink-0 mt-0.5" />
                    <div className="space-y-0.5">
                      <div className="text-[11px] font-bold text-[#121316]">Détection des Leads</div>
                      <div className="text-[10px] text-[#75777E]">Écoute et capture des demandes entrantes.</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-2.5 p-2.5 rounded-xl bg-[#FAF9F5] border border-[#EAE7DF]">
                    ...
                    <div className="space-y-0.5">
                      <div className="text-[11px] font-bold text-[#121316]">Relances 24h &amp; Brochures</div>
                      <div className="text-[10px] text-[#75777E]">Envoi automatique des devis et rappels.</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2 text-[11px] text-[#75777E] font-mono">
                <Lock className="w-3.5 h-3.5 text-[#15803D]" />
                <span>Protocole Officiel WhatsApp Multi-Device &middot; Chiffrement de bout en bout</span>
              </div>
              ...
              <div className="pt-2 flex items-center justify-end gap-3 font-mono">
                ...
                >
                  {loading ? (
                    ...
                    <>
                      <span>Authorize &amp; Link WhatsApp</span>
                      <ArrowRight className="w-3.5 h-3.5" />
                    </>
                  )}
                </button>
