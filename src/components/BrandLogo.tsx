    ...
    if (imageError && variant === "full") {
      return (
        <div className={`inline-flex items-center gap-2 select-none ${className}`}>
          <div className="w-7 h-7 rounded-lg bg-[#002E25] flex items-center justify-center text-emerald-300 font-bold font-mono text-sm border border-[#15803D]/40 shadow-2xs">
            O
          </div>
          <span className="font-extrabold text-[#121316] text-base tracking-tight font-sans">
